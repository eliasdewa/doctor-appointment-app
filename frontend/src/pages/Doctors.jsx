  ...
  return (
    <div>
      ...
      <div className="flex flex-col sm:flex-row items-start gap-5 mt-5">
        <button onClick={() => setShowFiler(prev => !prev)} className={`py-1 px-3 border rounded text-sm transition-all sm:hidden ${showFiler ? "bg-primary text-white" : ""}`}>Filter</button>
        <div className={`${showFiler ? "flex" : "hidden sm:flex"} flex-col gap-4 text-sm text-gray-600 `}>
